...
FormFieldElementObject titleFFEO(int idx, {bool reqField = true, String
startVal = ''}) =>
    FormFieldElementObject(
        index: idx,
...
FormFieldElementObject subTitleFFEO(int idx, {bool reqField = true, String
startVal = ''}) =>
    FormFieldElementObject(
        index: idx,
...
FormFieldElementObject urlFFEO(int idx, {bool reqField = true, String
startVal
= ''}) =>
    FormFieldElementObject(
        index: idx,
...
FormFieldElementObject bodyFFEO(int idx, {bool reqField = true, String
startVal
= ''}) =>
    FormFieldElementObject(
        index: idx,
